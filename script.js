...
console.log("Для корректной проверки каждого уровня сложности желательно перезагрузить страницу.\nИгра и трекер обновляется при одном клике на другую сложность, но при повторном нажатии не отображается.\nСостав колоды и остаток можно проверить в консоли при клике по фиолетовой карте.");